...
const heading = computed(() => props.title || String(props.statusCode));

useHead({
  title: `${props.statusCode} - ${props.title || "Not Found"} | Nuxt`,
  script: [],
  style: [
    {
...
<template>
  ...
  >
    ...
    <div class="max-w-520px text-center z-20">
      <h1 class="text-8xl sm:text-10xl font-medium mb-8" v-text="heading" />
      <p
