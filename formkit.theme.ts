...
/**
  ...
  *
  * @checksum - 1359adb0bd795e8ab39d031e4a2f18e5d933135fdd1e090ed91c6003d057b253
  * @variables - radius=rounded,accentColor=orange,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "date__input": {
    ...
    "selection:text-neutral-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-day-field]:bg-orange-600": true,
    "focus:[&::-webkit-datetime-edit-month-field]:bg-orange-600": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-orange-600": true
  },
